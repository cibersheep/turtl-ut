...
templates['sharing/noconnection'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<p class=\"page-empty\">\n	"
    ...
    + "\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Sharing requires a connection!", {"name":"t","hash":{},"data":data})))
    + "\n	<small>"
...
templates['sharing/nopersona'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<p class=\"page-empty nopersona\">\n	"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "share", {"name":"icon","hash":{},"data":data})))
    + "\n	<strong><a href=\"/personas?back=%2fsharing&open=1\">"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Create a persona</a></strong> to share.", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n\n";
},"useData":true});
templates['sharing/boards/item'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.board : depth0)) != null ? stack1.title : stack1), depth0));
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<div class=\"clearMe\"></div>\n<div class=\"unlocker\">\n	<form class=\"standard-form\">\n		<input type=\"text\" name=\"passphrase\" value=\"\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Passphrase", {"name":"t","hash":{},"data":data})))
    + "\">\n		<div class=\"submit\">\n			<div class=\"button\">\n				<input type=\"submit\" value=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Unlock and accept", {"name":"t","hash":{},"data":data})))
    + "\">\n			</div>\n		</div>\n	</form>\n</div>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"share-actions\"></div>\n<h2>\n	";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.board : depth0)) != null ? stack1.title : stack1), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(3, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "\n</h2>\n<p>\n	"
    + escapeExpression(((helper = (helper = helpers.permissions || (depth0 != null ? depth0.permissions : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"permissions","hash":{},"data":data}) : helper)))
    + " permissions\n</p>\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.has_passphrase : stack1), {"name":"if","hash":{},"fn":this.program(5, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\n\n";
},"useData":true});
templates['sharing/boards/list'] = template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "	<div class=\"content padded\">\n		<p>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You don't have any boards shared with you.", {"name":"t","hash":{},"data":data})))
    + "</p>\n	</div>\n";
},"3":function(depth0,helpers,partials,data) {
  return "	<ul class=\"item-list\"></ul>\n";
  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"content padded\">\n	<h2>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Boards shared with me", {"name":"t","hash":{},"data":data})))
    + "</h2>\n</div>\n";
...
templates['sharing/index'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "<div class=\"sharing\">\n	<div class=\"section invites-to-me\"></div>\n	<div class=\"section boards-to-me\"></div>\n</div>\n\n";
  },"useData":true});
templates['sharing/invites/item'] = template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<a href=\"#status-unlock\">"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "protected", {"name":"icon","hash":{},"data":data})))
    + "</a>\n";
},"3":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "		"
    + escapeExpression(lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.from_persona : stack1)) != null ? stack1.name : stack1), depth0))
    + "\n";
},"5":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "		"
    + escapeExpression(lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.from_persona : stack1)) != null ? stack1.email : stack1), depth0))
    + "\n";
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing, buffer = "<div class=\"invite-actions\"></div>\n<div class=\"status\">\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.has_passphrase : stack1), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</div>\n<h2>\n	"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.title : stack1), depth0))
    + "\n</h2>\n<p>\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "From", {"name":"t","hash":{},"data":data})))
    + "\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.from_persona : stack1)) != null ? stack1.name : stack1), {"name":"if","hash":{},"fn":this.program(3, data),"inverse":this.program(5, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</p>\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.invite : depth0)) != null ? stack1.has_passphrase : stack1), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\n";
},"useData":true});
templates['sharing/invites/list'] = template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "	<div class=\"content padded\">\n		<p>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You don't have any invites.", {"name":"t","hash":{},"data":data})))
    + "</p>\n	</div>\n";
},"3":function(depth0,helpers,partials,data) {
  return "	<ul class=\"item-list\"></ul>\n";
  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"content padded\">\n	<a class=\"extra\" href=\"#code\">"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Have an invite code?", {"name":"t","hash":{},"data":data})))
    + "</a>\n	<h2>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Pending invites", {"name":"t","hash":{},"data":data})))
    + "</h2>\n	<div class=\"invite-code\">\n		<form class=\"standard-form\">\n			<input type=\"text\" name=\"invite-code\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Enter your invite code", {"name":"t","hash":{},"data":data})))
    + "\">\n			<div class=\"submit\">\n				<div class=\"button\"><input type=\"submit\" value=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Add invite", {"name":"t","hash":{},"data":data})))
    + "\"></div>\n			</div>\n		</form>\n	</div>\n</div>\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.empty : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(3, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
...
templates['users/join'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\">\n		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Promo code: ", {"name":"t","hash":{},"data":data})))
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<a class=\"open-promo\" href=\"#open-promo\">"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Have a promo code?", {"name":"t","hash":{},"data":data})))
    + "</a>\n";
},"4":function(depth0,helpers,partials,data) {
  return "open";
  },"6":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "	<div class=\"autologin\">\n		<label>\n			<input type=\"checkbox\" name=\"autologin\" value=\"1\" ";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.autologin : depth0), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + ">\n			"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Stay logged in", {"name":"t","hash":{},"data":data})))
    + "\n		</label>\n	</div>\n";
  ...
  var stack1, helper, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, functionType="function", buffer = "<input type=\"text\" name=\"username\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Username (or email address)", {"name":"t","hash":{},"data":data})))
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "-->\n\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.show_autologin : depth0), {"name":"if","hash":{},"fn":this.program(6, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
...
templates['settings/index'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<ul class=\"item-list\">\n	<li>\n		<a href=\"/personas\">\n			"
    ...
    + "\n			"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Public persona", {"name":"t","hash":{},"data":data})))
...
templates['boards/share/nopersona'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, functionType="function";
  return "<p class=\"page-empty nopersona\">\n	"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "share", {"name":"icon","hash":{},"data":data})))
    + "\n	<strong><a href=\"/personas?back="
    + escapeExpression(((helper = (helper = helpers.back || (depth0 != null ? depth0.back : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"back","hash":{},"data":data}) : helper)))
    + "&open=1\">"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Create a persona</a></strong> to share.", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n\n";
},"useData":true});
templates['boards/share/invite'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<div class=\"loader\">\n	<input type=\"text\" class=\"req\" name=\"title\" value=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Invite to \"{{board_title}}\"", {"name":"t","hash":{
    'board_title': (((stack1 = (depth0 != null ? depth0.board : depth0)) != null ? stack1.title : stack1))
  },"data":data})))
    + "\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Invite title (shared with invitee)", {"name":"t","hash":{},"data":data})))
    + "\">\n	<input type=\"text\" class=\"req\" name=\"email\" value=\"\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Invitee's email address", {"name":"t","hash":{},"data":data})))
    + "\">\n	"
    + escapeExpression(((helpers.svg || (depth0 && depth0.svg) || helperMissing).call(depth0, "load", {"name":"svg","hash":{},"data":data})))
    + "\n</div>\n\n<div class=\"invite-type\"></div>\n\n<div class=\"challenge\">\n	<label>\n		<input type=\"checkbox\" name=\"use-challenge\" value=\"1\">\n		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Protect this invite", {"name":"t","hash":{},"data":data})))
    + " "
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "more", {"name":"icon","hash":{},"data":data})))
    + "\n	</label>\n	<div class=\"inner\">\n		<input type=\"text\" name=\"passphrase\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Enter a passphrase", {"name":"t","hash":{},"data":data})))
    + "\">\n		<p>\n			"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "This passphrase is used to encrypt the invite. You can communicate it to the invitee via a secure channel (in-person, encrypted email, encrypted chat, etc).", {"name":"t","hash":{},"data":data})))
    + "\n		</p>\n	</div>\n</div>\n\n";
},"useData":true});
templates['boards/share/index'] = template({"1":function(depth0,helpers,partials,data) {
  return "	<div class=\"members\"></div>\n	<div class=\"pending\"></div>\n";
  },"3":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "	<p class=\"page-empty\">\n		"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "share", {"name":"icon","hash":{},"data":data})))
    + "\n		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "This board is not shared", {"name":"t","hash":{},"data":data})))
    + "<br>\n		<small>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Tap the share button to start", {"name":"t","hash":{},"data":data})))
    + "</small>\n	</p>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.has_shares : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(3, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\n";
},"useData":true});
templates['boards/share/item'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.name : stack1), {"name":"if","hash":{},"fn":this.program(2, data),"inverse":this.program(4, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"2":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "			"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.name : stack1), depth0))
    + "\n";
},"4":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "			"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.email : stack1), depth0))
    + "\n";
},"6":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "		"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.share : depth0)) != null ? stack1.to : stack1), depth0))
    + "\n";
},"8":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "	<p>\n		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Invite pending. Sent {{ago}}", {"name":"t","hash":{
    'ago': (((helpers['ago-time'] || (depth0 && depth0['ago-time']) || helperMissing).call(depth0, (depth0 != null ? depth0.timestamp_created : depth0), {"name":"ago-time","hash":{},"data":data})))
  },"data":data})))
    + "\n	</p>\n";
},"10":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "	<p>\n		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "{{permissions}} permissions", {"name":"t","hash":{
    'permissions': ((depth0 != null ? depth0.permissions : depth0))
  },"data":data})))
    + "\n	</p>\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, buffer = "<div class=\"invite-actions\"></div>\n<h2>\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.persona : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(6, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</h2>\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.pending : depth0), {"name":"if","hash":{},"fn":this.program(8, data),"inverse":this.program(10, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\n";
},"useData":true});
templates['boards/share/invite_persona'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<p class=\"head\">\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "<em>{{email}}</em> has a Turtl persona. This share will be encrypted using their public key.", {"name":"t","hash":{
    'email': ((depth0 != null ? depth0.email : depth0))
  },"data":data})))
    + "\n</p>\n\n";
},"useData":true});
templates['boards/share/edit'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "";
},"useData":true});
templates['boards/share/invite_email'] = template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<em>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "{{email}}</em> needs to upgrade their persona.", {"name":"t","hash":{
    'email': ((depth0 != null ? depth0.email : depth0))
  },"data":data})))
    + "\n";
},"3":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<em>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "{{email}}</em> is not a current Turtl user.", {"name":"t","hash":{
    'email': ((depth0 != null ? depth0.email : depth0))
  },"data":data})))
    + "\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<p class=\"head\">\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.outdated_key : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.program(3, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "This share will happen over email. It's recommended you protect the invite.", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n\n";
},"useData":true});
...
templates['boards/item'] = template({"1":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "share", {"name":"icon","hash":{},"data":data})))
    + "\n";
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<small>- "
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Shared with me", {"name":"t","hash":{},"data":data})))
    + "</small>\n";
},"5":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "		<small>- "
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Sharing with {{num_shared_with}}", {"name":"t","hash":{
    'num_shared_with': ((depth0 != null ? depth0.num_shared_with : depth0))
  },"data":data})))
    + "\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.shared : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</div>\n<h2>\n	";
  ...
  buffer += "\n</h2>\n<p>\n	"
    ...
    + "\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.shared_with_me_directly : depth0), {"name":"if","hash":{},"fn":this.program(3, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.shared_by_me : depth0), {"name":"if","hash":{},"fn":this.program(5, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "</p>\n\n<div class=\"children\"></div>\n\n";
},"useData":true});
templates['boards/delete'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "		"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Are you sure you want to delete the board <em>{{parent}}{{board}}</em> as well as its children:", {"name":"t","hash":{
  ...
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "			"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Also delete notes in the above <strong>{{count}}</strong> boards", {"name":"t","hash":{
    'count': ((depth0 != null ? depth0.count : depth0))
  },"data":data})))
    + "\n";
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "<p class=\"warn\">\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.children : depth0)) != null ? stack1.length : stack1), {"name":"if","hash":{},"fn":this.program(1, data, depths),"inverse":this.program(4, data, depths),"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</p>\n<div class=\"fr delete-notes\">\n	<input id=\"delete_notes_"
    ...
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.board : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.children : depth0)) != null ? stack1.length : stack1), {"name":"if","hash":{},"fn":this.program(6, data, depths),"inverse":this.program(8, data, depths),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "	</label>\n</div>\n\n";
...
templates['personas/view'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "			<h3>("
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.name : stack1), depth0))
    + ")</h3>\n";
  ...
  return "			<p>"
    + escapeExpression(((helpers.svg || (depth0 && depth0.svg) || helperMissing).call(depth0, "load", {"name":"svg","hash":{},"data":data})))
    + " "
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Generating PGP key in background", {"name":"t","hash":{},"data":data})))
    + "</p>\n";
},"5":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.pubkey : stack1), {"name":"if","hash":{},"fn":this.program(6, data),"inverse":this.program(8, data),"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"6":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "				<code class=\"pkey\">\n					"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "lock", {"name":"icon","hash":{
    'class': ("lock")
  },"data":data})))
    + " "
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "{{keylen}} bit PGP key", {"name":"t","hash":{
    'keylen': ((depth0 != null ? depth0.keylen : depth0))
  },"data":data})))
    + "\n				</code>\n";
},"8":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "				<p>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "This persona doesn't have a key.", {"name":"t","hash":{},"data":data})))
    + "</p>\n				<div class=\"button generate\">\n					<input type=\"button\" class=\"button\" value=\"Generate key\">\n				</div>\n";
},"10":function(depth0,helpers,partials,data,depths) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, lambda=this.lambda, buffer = "			<div class=\"fr\">\n				<input type=\"checkbox\" value=\"1\" name=\""
    + escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"name","hash":{},"data":data}) : helper)))
    + "\" id=\""
    + escapeExpression(lambda(((stack1 = (depths[1] != null ? depths[1].persona : depths[1])) != null ? stack1.id : stack1), depth0))
    + "_"
    + escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"name","hash":{},"data":data}) : helper)))
    + "\" ";
  stack1 = ((helpers.contains || (depth0 && depth0.contains) || helperMissing).call(depth0, ((stack1 = (depths[1] != null ? depths[1].persona : depths[1])) != null ? stack1.settings : stack1), (depth0 != null ? depth0.name : depth0), {"name":"contains","hash":{},"fn":this.program(11, data, depths),"inverse":this.noop,"data":data}));
  if (stack1 != null) { buffer += stack1; }
  return buffer + ">\n				<label for=\""
    + escapeExpression(lambda(((stack1 = (depths[1] != null ? depths[1].persona : depths[1])) != null ? stack1.id : stack1), depth0))
    + "_"
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "<div class=\"content\">\n	<div class=\"head\">\n		<h1>"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.email : stack1), depth0))
    + "</h1>\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.name : stack1), {"name":"if","hash":{},"fn":this.program(1, data, depths),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "	</div>\n\n	<div class=\"key\">\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.generating : stack1), {"name":"if","hash":{},"fn":this.program(3, data, depths),"inverse":this.program(5, data, depths),"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "	</div>\n\n	<div class=\"settings\">\n";
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.settings : depth0), {"name":"each","hash":{},"fn":this.program(10, data, depths),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "	</div>\n</div>\n\n";
},"useData":true,"useDepths":true});
templates['personas/join'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, lambda=this.lambda;
  return "<p>\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "(Optional) Enable sharing by creating a persona", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n\n<input class=\"req\" type=\"text\" name=\"email\" value=\""
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.email : stack1), depth0))
    + "\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Your email address (required)", {"name":"t","hash":{},"data":data})))
    + "\">\n<input type=\"text\" name=\"name\" value=\""
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.name : stack1), depth0))
    + "\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Full name", {"name":"t","hash":{},"data":data})))
    + "\">\n\n<div class=\"buttons\">\n	<div class=\"button create\">\n		<input type=\"submit\" class=\"button\" value=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Enable sharing", {"name":"t","hash":{},"data":data})))
    + "\">\n	</div>\n	<p class=\"load\">\n		"
    + escapeExpression(((helpers.svg || (depth0 && depth0.svg) || helperMissing).call(depth0, "loading", {"name":"svg","hash":{},"data":data})))
    + "\n	</p>\n	<p>\n		<a href=\"/\">"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Skip this step", {"name":"t","hash":{},"data":data})))
    + "</a>\n	</p>\n</div>\n\n";
},"useData":true});
templates['personas/index'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "<div class=\"persona-view\"></div>\n\n";
  },"useData":true});
templates['personas/empty'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<p class=\"page-empty\">\n	"
    + escapeExpression(((helpers.icon || (depth0 && depth0.icon) || helperMissing).call(depth0, "persona", {"name":"icon","hash":{},"data":data})))
    + "\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You don't have a persona!", {"name":"t","hash":{},"data":data})))
    + "<br>\n	<small>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Personas enable sharing with others", {"name":"t","hash":{},"data":data})))
    + "</small>\n	<small>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Tap <em>+</em> to start", {"name":"t","hash":{},"data":data})))
    + "</small>\n</p>\n\n";
},"useData":true});
templates['personas/edit'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing;
  return "<input class=\"req\" type=\"text\" name=\"email\" value=\""
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.persona : depth0)) != null ? stack1.email : stack1), depth0))
    + "\" placeholder=\""
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Your email address (required)", {"name":"t","hash":{},"data":data})))
    + "\">\n<input type=\"text\" name=\"name\" value=\""
    ...
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Full name", {"name":"t","hash":{},"data":data})))
    + "\">\n\n<p>\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "Personas enable secure sharing with others by giving your account a name and email that others can look up.", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n<p>\n	"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You can remove your persona at any time, which will cancel all shares you have with others (making your account anonymous).", {"name":"t","hash":{},"data":data})))
    + "\n</p>\n\n";
},"useData":true});
...
templates['help/markdown'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"markdown-tutorial content\">\n	<p>\n		"
    ...
    + "</div>\n		</li>\n		<li>\n			<div>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You can also make text __bold__ or *italic*.", {"name":"t","hash":{},"data":data})))
    + "</div>\n			<div>"
    + escapeExpression(((helpers.t || (depth0 && depth0.t) || helperMissing).call(depth0, "You can also make text <strong>bold</strong> or <em>italic</em>.", {"name":"t","hash":{},"data":data})))
    + "</div>\n		</li>\n		<li>\n			<div>"
...
templates['notes/edit/boards/index'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, buffer = "					<div class=\"children\">\n						<ul class=\"item-list\">\n";
